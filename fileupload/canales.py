...
def table_cas(t_name):
    ...
    (
        ...
        `Employer` VARCHAR(25) CHARACTER SET utf8,
        `Employee_Location` VARCHAR(10) CHARACTER SET utf8,
        `Employee_Retirement_Date` VARCHAR(10) CHARACTER SET utf8,
        `Work_Phone` VARCHAR(13) CHARACTER SET utf8,
        `Work_Phone_Extension` INT,
        `Insured_1` VARCHAR(10) CHARACTER SET utf8,
        `Insured_Relationship_1` VARCHAR(10) CHARACTER SET utf8,
        `Insurance_Carrier_1` VARCHAR(10) CHARACTER SET utf8,
        `Accept_Assignment_1` VARCHAR(10) CHARACTER SET utf8,
        `Policy_Number_1` VARCHAR(20) CHARACTER SET utf8,
        `Group_Number_1` VARCHAR(20) CHARACTER SET utf8,
        ...
        `Insured_2` VARCHAR(10) CHARACTER SET utf8,
        `Insured_Relationship_2` VARCHAR(10) CHARACTER SET utf8,
        `Insurance_Carrier_2` VARCHAR(10) CHARACTER SET utf8,
        `Accept_Assignment_2` VARCHAR(10) CHARACTER SET utf8,
        `Policy_Number_2` VARCHAR(20) CHARACTER SET utf8,
        `Group_Number_2` VARCHAR(20) CHARACTER SET utf8,
        ...
        `Insured_3` VARCHAR(10) CHARACTER SET utf8,
        `Insured_Relationship_3` VARCHAR(10) CHARACTER SET utf8,
        `Insurance_Carrier_3` VARCHAR(10) CHARACTER SET utf8,
        `Accept_Assignment_3` VARCHAR(10) CHARACTER SET utf8,
        `Policy_Number_3` VARCHAR(20) CHARACTER SET utf8,
        `Group_Number_3` VARCHAR(20) CHARACTER SET utf8,
        ...
        `Facility` VARCHAR(10) CHARACTER SET utf8,
        `Related_to_Employment` VARCHAR(10) CHARACTER SET utf8,
        `Related_to_Accident` VARCHAR(10) CHARACTER SET utf8,
        `Nature_of_Accident` VARCHAR(10) CHARACTER SET utf8,
        ...
        `Lab_Charges` INT,
        `Date_of_Injury_Illness` VARCHAR(10) CHARACTER SET utf8,
        `Date_First_Consulted` VARCHAR(10) CHARACTER SET utf8,
        `Date_Unable_to_Work_From` VARCHAR(10) CHARACTER SET utf8,
        `Date_Unable_to_Work_To` VARCHAR(10) CHARACTER SET utf8,
        `Date_Tot_Disability_From` VARCHAR(10) CHARACTER SET utf8,
        `Date_Tot_Disability_To` VARCHAR(10) CHARACTER SET utf8,
        `Date_Part_Disability_From` VARCHAR(10) CHARACTER SET utf8,
        `Date_Part_Disability_To` VARCHAR(10) CHARACTER SET utf8,
        `Hospital_Date_From` VARCHAR(10) CHARACTER SET utf8,
        `Hospital_Date_To` VARCHAR(10) CHARACTER SET utf8,
        `Prior_Authorization_No` VARCHAR(10) CHARACTER SET utf8,
        ...
        `Local_Use_B` VARCHAR(12) CHARACTER SET utf8,
        ...
        `Estimated_Date_of_Birth` VARCHAR(10) CHARACTER SET utf8,
        ...
        `Global_Coverage_End_Date` VARCHAR(10) CHARACTER SET utf8,
        `Global_Coverage_Start_Date` VARCHAR(10) CHARACTER SET utf8,
        ...
        `Group_Name_3` VARCHAR(24) CHARACTER SET utf8,
        `Special_Program_Code` INT,
        `Note_Reference_Code` VARCHAR(20) CHARACTER SET utf8,
        `Contract_Type_Code` INT,
        `Contract_Amount` VARCHAR(12) CHARACTER SET utf8,
        `Contract_Percent` VARCHAR(12) CHARACTER SET utf8,
        `Contract_Code` VARCHAR(12) CHARACTER SET utf8,
        `Terms_Discount_Percent` VARCHAR(12) CHARACTER SET utf8,
        `Contract_Version_Identifier` VARCHAR(12) CHARACTER SET utf8,
        `Condition_Description_1` VARCHAR(12) CHARACTER SET utf8,
        `Condition_Description_2` VARCHAR(12) CHARACTER SET utf8,
        `Diagnosis_Code9` VARCHAR(12) CHARACTER SET utf8,
        `Diagnosis_Code10` VARCHAR(12) CHARACTER SET utf8,
        `Diagnosis_Code11` VARCHAR(12) CHARACTER SET utf8,
        `Diagnosis_Code12` VARCHAR(12) CHARACTER SET utf8,
        `Diagnosis_Code9_POA` VARCHAR(12) CHARACTER SET utf8,
        `Diagnosis_Code10_POA` VARCHAR(12) CHARACTER SET utf8,
        `Diagnosis_Code11_POA` VARCHAR(12) CHARACTER SET utf8,
        `Diagnosis_Code12_POA` VARCHAR(12) CHARACTER SET utf8,
...
def table_pat(t_name):
    ...
    (
    `Item` INT,
    `Chart_Number` VARCHAR(10) CHARACTER SET utf8,
