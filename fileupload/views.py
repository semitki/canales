...
class PostProcessView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        sqlReport = ("INSERT INTO `explorer_query` "
            ...
            "case c.Insured_Relationship_1 WHEN \"Self\" Then \"\" ELSE CASE p1.Sex WHEN \"Female\" THEN \"F\" WHEN \"Male\" THEN \"M\" ELSE \"U\" END END AS Insured_Gender_P,\r\n "
            ...
            "case c.Insured_Relationship_2 WHEN \"Self\" Then \"\" ELSE CASE p2.Sex WHEN \"Female\" THEN \"F\" WHEN \"Male\" THEN \"M\" ELSE \"U\" END END AS Insured_Gender_S,\r\n "
            ...
            "case c.Insured_Relationship_3 WHEN \"Self\" Then \"\" ELSE CASE p3.Sex WHEN \"Female\" THEN \"F\" WHEN \"Male\" THEN \"M\" ELSE \"U\" END END AS Insured_Gender_T,\r\n "
            ...
            "g.Date_of_Birth as Guarantor_DOB,\r\n "
