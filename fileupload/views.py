...
class PostProcessView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        sqlReport = ("INSERT INTO `explorer_query` "
            ...
            "DATE_Format(p1.Date_of_Birth, \"%m/%d/%Y\")  as Insured_DOB_P, \r\n "
            ...
            "/* INSURANCE NUMBER 2 DATA  */\r\n c.Insurance_Carrier_2 as HF_Payer_ID_S, \"\" as Insurante_Type_S, "
            "\r\n c.Group_Name_2 as Insurance_Group_Name_S,c.Group_Number_2 as Insurance_Group_Number_S, \r\n "
            "c.Policy_Number_2 as Insurance_ID_Number_S, \"\" as CoPay_S,  \r\n "
            ...
            "DATE_Format(p3.Date_of_Birth, \"%m/%d/%Y\")  as Insured_DOB_T, \r\n "
            ...
            "\r\n g.Last_Name as Guarantor_Last_Name, DATE_Format(g.Date_of_Birth, \"%m/%d/%Y\") as Guarantor_DOB,\r\n "
            ...
            "g.Chart_Number as Guarantor_Account_Number, \r\n CASE g.Language WHEN \"English\" THEN \"EN\" "
            "WHEN \"Spanish\" THEN \"ES\" ELSE \"PD\" END AS Language, \r\n /* NPI for Referring? */\r\n "
